...
## My fork from https://github.com/Poeschl/Hassio-Addons
## This syncs folders from a remote to Home Assistant 

Sync folders ~~to~~ from a remote machine via ssh and rsync.
